...
<body>
    <div class="container">
        ...
        <main class="product_list">
            <img src="f391fed5-cc5f-4f95-b6e2-1a7c08671657.webp" alt="">
            <div class="pro">
                <h3>Nike Mercurial Superfly 7 Elite SE FG</h3><br><br>
                <p>size:39,40,41,42,43</p>
                <p>Colors: red, blue, black,white.</p>
                <p>Sale: 40%</p>
                <h4>Costs: 182$</h4><br><br>
                <button>Buy</button>
